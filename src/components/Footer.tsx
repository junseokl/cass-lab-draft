    ...
    <footer className="bg-zinc-950 text-zinc-100 border-t border-zinc-900 pt-16 pb-12">
      <div className="mx-auto max-w-7xl px-6 md:px-10">
          ...
          <div className="flex flex-col gap-4">
            <div className="flex items-center gap-3">
              <div className="relative h-6 w-6 border-l border-t border-zinc-100">
                <div className="absolute bottom-0 right-0 h-2.5 w-2.5 bg-emerald-500" />
              </div>
            ...
            <div className="flex flex-wrap gap-2 mt-2">
              <span className="inline-flex items-center text-[10px] font-mono tracking-wider bg-zinc-900 border border-zinc-800 text-emerald-400 px-2 py-0.5 uppercase">
                INST_ID: RM402-CAB
              </span>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 font-sans text-sm text-zinc-400 leading-relaxed">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <a href="mailto:director@casslab.edu" className="hover:text-emerald-400 transition-colors">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6 pt-8 text-xs font-mono text-zinc-600">
          <div>
            <span>© 2026 CASS Lab. Directed by Dr. Liang Chen.</span>
